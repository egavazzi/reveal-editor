// Inline SVG icons for the editor chrome (feather-style, stroke-based).
// Rendered with {@html icon('name')}; they inherit color via currentColor.

const PATHS = {
  text: '<path d="M4 7V4h16v3"/><path d="M9 20h6"/><path d="M12 4v16"/>',
  image: '<rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/>',
  video: '<polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2"/>',
  shapes: '<rect x="3" y="3" width="9" height="9" rx="1"/><circle cx="16" cy="16" r="5"/>',
  ...
  arrange: '<rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/>',
  undo: '<polyline points="9 14 4 9 9 4"/><path d="M20 20v-7a4 4 0 0 0-4-4H4"/>',
  redo: '<polyline points="15 14 20 9 15 4"/><path d="M4 20v-7a4 4 0 0 1 4-4h12"/>',
  save: '<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/>',
  play: '<polygon points="6 3 20 12 6 21 6 3"/>',
  playFrom: '<line x1="4" y1="3" x2="4" y2="21"/><polygon points="9 4 21 12 9 20"/>',
  ...
  pin: '<path d="M12 16v6"/><path d="M9 3h6v5l2.5 2.5V13h-11v-2.5L9 8z"/>',
  ...
  unlink: '<path d="M13.41 10.59a5 5 0 0 1 .53 6.49l-3 3a5 5 0 0 1-7.07-7.07l1.71-1.71"/><path d="M10.59 13.41a5 5 0 0 1-.53-6.49l3-3a5 5 0 0 1 7.07 7.07l-1.71 1.71"/><line x1="2" y1="2" x2="22" y2="22"/>',
  listUl: '<line x1="9" y1="6" x2="21" y2="6"/><line x1="9" y1="12" x2="21" y2="12"/><line x1="9" y1="18" x2="21" y2="18"/><circle cx="4.5" cy="6" r="1"/><circle cx="4.5" cy="12" r="1"/><circle cx="4.5" cy="18" r="1"/>',
  listOl: '<line x1="10" y1="6" x2="21" y2="6"/><line x1="10" y1="12" x2="21" y2="12"/><line x1="10" y1="18" x2="21" y2="18"/><text x="2" y="8.5" font-size="7.5" fill="currentColor" stroke="none">1</text><text x="2" y="14.5" font-size="7.5" fill="currentColor" stroke="none">2</text><text x="2" y="20.5" font-size="7.5" fill="currentColor" stroke="none">3</text>',
  quote: '<path d="M6 17c2-1 3-3 3-5H5V6h6v6c0 3-2 5-5 5z" fill="currentColor" stroke="none"/><path d="M14 17c2-1 3-3 3-5h-4V6h6v6c0 3-2 5-5 5z" fill="currentColor" stroke="none"/>',
  ...
  clearFormat: '<path d="M4 7V4h14v3"/><path d="M8 20h4"/><path d="M11 4 10 20"/><line x1="16" y1="15" x2="22" y2="21"/><line x1="22" y1="15" x2="16" y2="21"/>',
  ...
  vAlignTop: '<line x1="3" y1="3" x2="21" y2="3"/><line x1="3" y1="21" x2="21" y2="21"/><line x1="6" y1="8" x2="18" y2="8"/><line x1="6" y1="12" x2="18" y2="12"/>',
  vAlignMiddle: '<line x1="3" y1="3" x2="21" y2="3"/><line x1="3" y1="21" x2="21" y2="21"/><line x1="6" y1="10" x2="18" y2="10"/><line x1="6" y1="14" x2="18" y2="14"/>',
  vAlignBottom: '<line x1="3" y1="3" x2="21" y2="3"/><line x1="3" y1="21" x2="21" y2="21"/><line x1="6" y1="12" x2="18" y2="12"/><line x1="6" y1="16" x2="18" y2="16"/>',
